...
const AnglesController = Chart.controllers.line.extend({
	dataElementType: Angle
});

export class Controller extends AnglesController {
    ...
    calculatePointPosition(dataIndex) {
		...
		return scale.getPointPosition(data.r, data.a);
	}
}